    ...
    */
    ...
    if (solved)
    {
        ...
        for (size_t path_idx = 0; path_idx < path->getStateCount(); path_idx++)
        {
            ...
            *
            */
            path_point_temp.x() = state->values[0];
            path_point_temp.y() = state->values[1];
            path_point_temp.z() = state->values[2];
            path_points.push_back(path_point_temp);
        }
